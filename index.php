        ...
        <div class="small">Discover the best gyms & fitness centres in your locality</div><div class="search">
           ...
           <?php if(isset($id)){
            ...
            <form action="" method="POST">
               <input type="text" class="location" placeholder="" name="location">
              
               <input type="submit" name="search" value="Get Gyms">
           </form>
         </div>';
...
<!-- <button class="secondHalf">
  <li><a href="/partner">Join</a></li></div>
</div> -->
</section>
